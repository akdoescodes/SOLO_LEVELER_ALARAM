          ...
          return (
            <View key={index} style={styles.daySquare}>
              <Text 
                style={[
                  styles.dayText, 
                  isSelected ? styles.dayTextSelected : styles.dayTextInactive
                ]}
              >
                {dayAbbr}
              </Text>
...
const styles = StyleSheet.create({
  ...
  dayTextSelected: {
    color: theme.colors.gradient.primary[0], // Use the first gradient color (green)
    fontFamily: theme.typography.fontFamily.bold, // Make it bolder
    fontSize: theme.typography.fontSize.xs, // Keep same size as others
    shadowColor: theme.colors.gradient.primary[0],
