            ...
            <View style={styles.rightContent}>
              <Switch
                ...
                trackColor={{ 
                  ...
                  true: theme.colors.gradient.primary[0] // Full blue color when on
                }}
                thumbColor={alarm.enabled ? theme.colors.gradient.primary[1] : "rgba(255, 255, 255, 0.9)"} // Blue thumb when on
