...
import { Clock, TrendingUp, Target } from 'lucide-react-native';
...
export function AlarmInsightCard({
  ...
  const moodOptions: MoodOption[] = [
    ...
    { id: "focused", label: "Focused", emoji: "🧘‍♂️" },
  ...
  return (
    <View style={styles.container}>
      <View style={[styles.card, commonStyles.glassCard]}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <GradientIcon icon={Target} size={18} />
            <Text style={styles.sectionTitle}>Wake Mood</Text>
          </View>
              ...
              >
                {selectedMood === mood.id && (
                  <LinearGradient
                    ...
                    style={styles.moodGradientOverlay}
                  />
                )}
