            ...
            <View 
              style={[
                styles.dropdownMenu,
                {
                  ...
                  right: 16, // Touch the screen edge with some margin
                  left: buttonPosition.x - 140, // Extend left from button position
                }
              ]}
            >
              <TouchableOpacity 
...
const styles = StyleSheet.create({
  ...
  dropdownMenu: {
    position: 'absolute',
    top: theme.spacing.lg + 40 + theme.spacing.sm + 32, // Position below the 3-dot button
    right: 0, // Touch the right edge of the screen
    ...
    minWidth: 120,
    width: 160, // Fixed width extending from button to screen edge
    zIndex: 1000,
  },
  modalOverlay: {
    flex: 1,
