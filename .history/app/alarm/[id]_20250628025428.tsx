        ...
        <View style={styles.quoteContainer}>
          <PanGestureHandler onGestureEvent={gestureHandler}>
            <Animated.View style={[styles.animatedContainer, animatedStyle]}>
              <View style={styles.fullScreenQuoteCard}>
                <LinearGradient
                  colors={[
                    currentQuote.gradientColors?.[0] || '#DC2626',
                    currentQuote.gradientColors?.[1] || '#B91C1C',
                    currentQuote.gradientColors?.[2] || '#991B1B'
                  ]}
                  ...
                  <View style={styles.quoteCardContent}>
                    ...
                    <View style={styles.quoteMeta}>
                      <Text style={styles.quoteNumber}>
                        {currentQuoteIndex + 1} of {shuffledQuotes.length}
                      </Text>
                    </View>
                  </View>
                </LinearGradient>
