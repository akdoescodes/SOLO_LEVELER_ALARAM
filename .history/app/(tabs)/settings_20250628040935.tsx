          ...
          <View style={styles.section}>
            ...
            <View style={styles.settingRow}>
              ...
              <Switch
                ...
                trackColor={{ false: theme.colors.surfaceDark, true: theme.colors.accent }}
                thumbColor={settings.soundEnabled ? theme.colors.textPrimary : theme.colors.textSecondary}
              />
            </View>
